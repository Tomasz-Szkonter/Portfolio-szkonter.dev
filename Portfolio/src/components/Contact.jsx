...
import { EarthCanvas, MoonCanvas } from "./canvas";
...
const Contact = () => {
  ...
  return (
    <>
    <div className="xl:my-12 xl:flex-row flex-col-reverse flex fap-10 overflow-hidden">
      <motion.div
        variants={slideIn("left", "tween", 0.2, 1)}
        className="flex-[0.75] bg-dark-100 p-8 rounded-2xl"
      >
